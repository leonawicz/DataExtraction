...
##  sum(s005pct)/length(s005pct)  5.287  5.287  5.714434  5.598  5.598
##  sum(s010pct)/length(s010pct)  9.641  9.952 10.215344  9.952 10.263
##  sum(s025pct)/length(s025pct) 23.325 23.636 24.203471 23.637 23.947
##  sum(s100pct)/length(s100pct) 92.056 92.367 93.491177 92.368 92.679
##      max neval
##  427.627 10000
##  103.563 10000
##  719.968 10000
...
## Unit: microseconds
##                          expr        min         lq         mean
##  sum(s005pct)/length(s005pct)      5.287      7.464     10.99699
##            mean(v, na.rm = T) 388839.215 394164.182 399642.36073
##              sum(d)/length(d)   1484.099   1492.651   1514.49002
##                 mean(s005pct)     18.038     20.837     46.94261
##      median         uq        max neval
##       9.330     11.507     21.459   100
##  394934.377 405617.588 420794.304   100
##    1503.381   1524.996   1812.828   100
##      56.291     64.533    104.807   100
```
...
##                mean(v, na.rm = T) 392.74726 394.36913 402.04998 395.13031
##                  mean(v[dat.ind])  11.65416  14.07857  15.30730  14.14621
##                sum(v[dat.ind])/nd  11.70205  12.56772  14.93817  12.64003
##       .Internal(mean(v[dat.ind]))  11.70485  13.99631  15.42883  14.06395
##  .Primitive("sum")(v[dat.ind])/nd  10.42539  12.57254  13.79598  12.63801
##         uq       max neval
##  409.54274 504.54886   100
##   14.37091  35.58012   100
##   12.75837  39.98141   100
##   14.14419  38.83071   100
##   12.75168  35.14876   100
```
...
## Unit: milliseconds
##                expr       min        lq      mean    median        uq
##    mean(v[dat.ind]) 11.387940 14.094119 16.278188 14.269213 14.854518
##  sum(v[dat.ind])/nd 10.018601 12.606445 14.475720 12.753703 13.203878
##             mean(d)  2.944873  2.963222  3.052110  2.984681  3.047349
##           sum(d)/nd  1.483477  1.496539  1.556648  1.508046  1.544900
##         max neval
##  131.998660  1000
##  129.162949  1000
##    4.768274  1000
