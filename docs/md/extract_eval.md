...
##  sum(s005pct)/length(s005pct)  4.976  5.287  5.600733  5.598  5.598
##  sum(s010pct)/length(s010pct)  9.641  9.952 10.156746  9.952 10.263
##  sum(s025pct)/length(s025pct) 23.325 23.636 24.176607 23.636 23.947
##  sum(s100pct)/length(s100pct) 92.056 92.367 94.179795 92.368 92.368
##       max neval
##   285.499 10000
##   177.892 10000
##  1838.640 10000
...
## Unit: microseconds
##                          expr        min         lq         mean
##  sum(s005pct)/length(s005pct)      5.287      7.153     10.86638
##            mean(v, na.rm = T) 388821.488 394372.086 400103.63502
##              sum(d)/length(d)   1478.812   1482.855   1496.61367
##                 mean(s005pct)     18.660     20.526     46.22102
##      median         uq        max neval
##       9.330     10.263     20.837   100
##  395114.602 402799.760 503114.213   100
##    1488.453   1498.716   1693.403   100
##      55.358     64.066     70.597   100
```
...
##                mean(v, na.rm = T) 391.03489 394.16480 401.19636 395.20308
##                  mean(v[dat.ind])  11.41437  13.96443  14.97814  14.03316
##                sum(v[dat.ind])/nd  10.35790  12.51423  14.14173  12.56726
##       .Internal(mean(v[dat.ind]))  13.06237  13.90892  14.97103  13.97190
##  .Primitive("sum")(v[dat.ind])/nd  10.75847  12.49417  13.62512  12.57426
##         uq       max neval
##  408.21445 503.80495   100
##   14.10936  36.31688   100
##   12.63661  35.33941   100
##   14.02321  36.38188   100
##   12.64687  34.86544   100
```
...
## Unit: milliseconds
##                expr       min        lq      mean    median        uq
##    mean(v[dat.ind]) 11.403179 13.988067 15.638456 14.047936 14.138283
##  sum(v[dat.ind])/nd  9.899177 12.509722 14.010039 12.568191 12.648740
##             mean(d)  2.939585  2.946117  2.986212  2.949849  2.974884
##           sum(d)/nd  1.479745  1.483477  1.505726  1.490319  1.494673
##         max neval
##  128.109587  1000
##   35.849138  1000
##    4.255122  1000
