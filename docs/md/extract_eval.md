...
##  sum(s005pct)/length(s005pct)  5.287  5.288  5.790186  5.599  5.599
##  sum(s010pct)/length(s010pct)  9.642  9.953 10.697310  9.953 10.264
##  sum(s025pct)/length(s025pct) 23.326 23.637 25.410862 23.948 23.948
##  sum(s100pct)/length(s100pct) 92.057 92.369 95.325950 92.369 92.990
##       max neval
##   126.579 10000
##  1060.208 10000
##  9172.082 10000
...
## Unit: microseconds
##                          expr        min         lq         mean
##  sum(s005pct)/length(s005pct)      5.288      7.465     10.97936
##            mean(v, na.rm = T) 396206.083 397348.240 405108.45996
##              sum(d)/length(d)   1479.128   1488.769   1531.67196
##                 mean(s005pct)     18.039     20.527     45.54411
##      median         uq        max neval
##       9.642     10.886     22.393   100
##  398453.698 409459.603 569982.678   100
##    1498.410   1525.312   2293.333   100
##      54.115     62.823     68.110   100
```
...
##                mean(v, na.rm = T) 396.28943 397.54853 404.17929 398.34578
##                  mean(v[dat.ind])  11.56867  14.03538  16.16302  14.11111
##                sum(v[dat.ind])/nd  11.75029  12.53293  14.23889  12.60244
##       .Internal(mean(v[dat.ind]))  13.19490  13.95312  15.95789  13.99479
##  .Primitive("sum")(v[dat.ind])/nd  11.78699  12.52453  13.93073  12.60088
##         uq       max neval
##  412.53448 474.30250   100
##   14.23536  39.33962   100
##   12.77520  37.49786   100
##   14.12899 127.58249   100
##   12.73524  33.90485   100
```
...
## Unit: milliseconds
##                expr       min        lq      mean    median        uq
##    mean(v[dat.ind]) 11.611895 14.015632 15.772107 14.075344 14.199745
##  sum(v[dat.ind])/nd 11.671297 12.531685 14.203151 12.592329 12.703824
##             mean(d)  2.940528  2.950169  3.008143  2.959655  3.010969
##           sum(d)/nd  1.479751  1.484726  1.520740  1.492812  1.513961
##         max neval
##  126.620867  1000
##  126.241755  1000
##    4.111141  1000
