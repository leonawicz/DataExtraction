...
##  sum(s005pct)/length(s005pct)  5.288  5.288  5.679122  5.599  5.599
##  sum(s010pct)/length(s010pct)  9.642  9.953 10.260327  9.953 10.264
##  sum(s025pct)/length(s025pct) 23.326 23.637 24.292062 23.638 23.949
##  sum(s100pct)/length(s100pct) 92.058 92.369 93.632429 92.370 92.681
##      max neval
##   78.064 10000
##  153.326 10000
##  552.035 10000
...
## Unit: microseconds
##                          expr        min         lq         mean
##  sum(s005pct)/length(s005pct)      5.288      7.465     11.24378
##            mean(v, na.rm = T) 394617.122 396813.908 404414.05779
##              sum(d)/length(d)   1482.563   1491.115   1520.50560
##                 mean(s005pct)     18.039     20.216     45.85255
##      median          uq        max neval
##       9.642     11.0415     27.991   100
##  398206.745 408209.6060 514360.978   100
##    1501.689   1520.8165   1973.329   100
##      56.293     63.7570     70.599   100
```
...
##                mean(v, na.rm = T) 394.78195 395.99099 403.52892 396.96972
##                  mean(v[dat.ind])  13.16268  13.31149  14.44416  13.62732
##                sum(v[dat.ind])/nd  11.64653  11.80887  13.50582  12.09188
##       .Internal(mean(v[dat.ind]))  13.07435  13.23265  14.98008  13.46933
##  .Primitive("sum")(v[dat.ind])/nd  11.67763  11.83313  13.72128  12.53849
##         uq       max neval
##  410.12400 516.16294   100
##   14.16955  30.74380   100
##   12.75075  36.88118   100
##   14.14576  38.44895   100
##   12.69834  36.00072   100
```
...
## Unit: milliseconds
##                expr       min        lq      mean    median        uq
##    mean(v[dat.ind]) 13.131574 13.374315 15.263225 14.113574 14.244041
##  sum(v[dat.ind])/nd 11.646524 11.872004 13.905027 12.621837 12.744995
##             mean(d)  2.945221  2.960459  2.994604  2.970101  2.996382
##           sum(d)/nd  1.484118  1.493759  1.515009  1.499669  1.509620
##         max neval
##   45.327147  1000
##  127.996069  1000
##    4.950893  1000
