...
##  sum(s005pct)/length(s005pct)  4.976  5.287  5.69475  5.287  5.598
##  sum(s010pct)/length(s010pct)  9.641  9.952 10.36300  9.952 10.263
##  sum(s025pct)/length(s025pct) 23.325 23.636 24.51426 23.637 23.947
##  sum(s100pct)/length(s100pct) 92.056 92.367 94.69702 92.368 92.679
##       max neval
##   172.295 10000
##   130.310 10000
##   429.804 10000
...
## Unit: microseconds
##                          expr        min         lq         mean
##  sum(s005pct)/length(s005pct)      5.287      7.464     11.10586
##            mean(v, na.rm = T) 392841.803 394754.152 402416.70213
##              sum(d)/length(d)   1483.477   1495.762   1521.89181
##                 mean(s005pct)     18.038     20.682     46.89284
##      median          uq        max neval
##       9.641     11.3515     22.392   100
##  397355.990 408180.0850 504257.765   100
##    1505.091   1530.7490   1770.842   100
##      55.669     64.3770     93.611   100
```
...
##                mean(v, na.rm = T) 393.32914 394.52759 402.21052 395.60925
##                  mean(v[dat.ind])  12.00559  14.00844  15.08224  14.07888
##                sum(v[dat.ind])/nd  11.66909  12.53802  14.77446  12.60131
##       .Internal(mean(v[dat.ind]))  13.07326  13.94484  15.49330  14.01435
##  .Primitive("sum")(v[dat.ind])/nd  11.66535  12.55466  13.73424  12.63272
##         uq       max neval
##  407.66242 505.81153   100
##   14.19566  34.97180   100
##   12.73147  36.05969   100
##   14.12522  38.89633   100
##   12.74157  36.21083   100
```
...
## Unit: milliseconds
##                expr       min        lq      mean    median        uq
##    mean(v[dat.ind]) 11.423706 13.993510 15.427615 14.069084 14.187887
##  sum(v[dat.ind])/nd 11.581383 12.513921 14.273734 12.582808 12.727269
##             mean(d)  2.938341  2.947049  3.000841  2.954825  2.992456
##           sum(d)/nd  1.478501  1.484099  1.513294  1.490941  1.505558
##         max neval
##   46.124004  1000
##  123.249878  1000
##    5.169466  1000
