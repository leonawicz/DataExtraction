...
##  sum(s005pct)/length(s005pct)  4.976  5.287  5.593206  5.287  5.598
##  sum(s010pct)/length(s010pct)  9.641  9.952 10.206170  9.952 10.263
##  sum(s025pct)/length(s025pct) 23.325 23.636 24.100902 23.637 23.947
##  sum(s100pct)/length(s100pct) 92.056 92.367 94.069328 92.368 92.678
##       max neval
##    91.434 10000
##   189.711 10000
##   380.977 10000
...
## Unit: microseconds
##                          expr        min         lq         mean
##  sum(s005pct)/length(s005pct)      5.287      7.153     10.99080
##            mean(v, na.rm = T) 392910.224 393667.202 401508.71784
##              sum(d)/length(d)   1485.343   1494.673   1513.95511
##                 mean(s005pct)     18.038     20.526     47.34066
##       median         uq        max neval
##       9.6410     11.196     22.703   100
##  395279.2780 406332.114 510015.025   100
##    1502.1370   1518.932   1832.110   100
##      57.2245     64.377    108.850   100
```
...
##                mean(v, na.rm = T) 392.87166 394.22327 403.45858 397.49827
##                  mean(v[dat.ind])  13.14821  13.43868  15.67489  14.07235
##                sum(v[dat.ind])/nd  11.62741  11.87326  13.48359  12.59012
##       .Internal(mean(v[dat.ind]))  13.10965  13.29593  14.41560  13.92618
##  .Primitive("sum")(v[dat.ind])/nd  11.69708  11.89643  13.81963  12.59540
##         uq       max neval
##  409.93507 509.07176   100
##   14.21852  40.02527   100
##   12.69897  42.67686   100
##   14.11776  31.70504   100
##   12.73520  37.40414   100
```
...
## Unit: milliseconds
##                expr       min        lq      mean    median        uq
##    mean(v[dat.ind]) 13.119908 13.404630 15.541724 14.101739 14.188353
##  sum(v[dat.ind])/nd 11.653225 11.956762 13.827187 12.612976 12.700678
##             mean(d)  2.946117  2.964777  2.996609  2.975973  3.005362
##           sum(d)/nd  1.482855  1.494673  1.512901  1.500271  1.512711
##         max neval
##  128.038989  1000
##  126.924983  1000
##    3.781155  1000
